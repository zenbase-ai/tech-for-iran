...
/**
 * SignatoryNotFound - Custom 404 page for invalid signatory IDs.
 *
 * Explains that the signatory wasn't found and provides a CTA
 * to sign the letter themselves.
 */
export default function SignatoryNotFound() {
  "use memo"
    ...
    <VStack as="main" className="min-h-svh" items="stretch">
      ...
      >
        <VStack className="gap-4 text-center" items="center">
          <h1 className="text-2xl md:text-3xl font-bold">Signatory not found</h1>
          <p className="text-muted-foreground max-w-md leading-relaxed">
            This link may be invalid or the signatory may have been removed from the letter.
          </p>
        </VStack>
