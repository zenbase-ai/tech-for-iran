...
export const SelectGroup: React.FC<React.ComponentProps<typeof SelectPrimitive.Group>> = ({
  ...props
}) => <SelectPrimitive.Group data-slot="select-group" {...props} />

export const SelectValue: React.FC<React.ComponentProps<typeof SelectPrimitive.Value>> = ({
  ...props
...
export const SelectContent: React.FC<React.ComponentProps<typeof SelectPrimitive.Content>> = ({
  className,
  children,
  position = "popper",
  align = "center",
...
export const SelectItem: React.FC<React.ComponentProps<typeof SelectPrimitive.Item>> = ({
  className,
  children,
  ...props
}) => (
