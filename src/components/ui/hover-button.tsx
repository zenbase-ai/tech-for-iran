...
const hoverButtonVariants = cva(
  "group relative w-auto cursor-pointer overflow-hidden border border-transparent border-2 rounded-sm p-2 px-4 sm:px-6 text-center text-sm sm:text-base font-semibold disabled:pointer-events-none disabled:opacity-50 ",
  {
    variants: {
      variant: {
...
const dotVariants = cva(
  "h-2 w-2 rounded-sm transition-all duration-300 group-hover:scale-[100.8]",
  {
    variants: {
      variant: {
